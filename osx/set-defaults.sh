...
if [ -n "$hostname" ]
  ...
  user ' - What shall we call this computer?'
  read -e hostname
...
# Try e.g. `cd /tmp; unicode "\x{0000}" > cc.txt; open -e cc.txt`
...
defaults write NSGlobalDomain AppleLanguages -array "en_GB" "en"
...
# Set Safari’s home page to `google.co.uk`
defaults write com.apple.Safari HomePage -string "google.co.uk"
